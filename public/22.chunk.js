            ...
            case 'Guardar':
                ...
                this.helperService.POST("/api/affiliates", this.model).subscribe(function (rs) {
                    ...
                    if (res.store) {
                        ...
                        _this.snackBar.open(res.message, '', { duration: 3500 });
                        _this.model.document_number = '';
                        _this.loaderService.display(false);
                    }
                }, function (err) {
                    _this.loaderService.display(false);
...
var AffiliatesListComponent = /** @class */ (function (_super) {
    ...
    AffiliatesListComponent.prototype.getFullName = function (name1, name2, lastname1, lastname2) {
