...
class MiPresController extends Controller
{
    ...
    public function direccionamientoXPrescripcion(Request $request, $prescription)
    {
        try{
            ...
            $response = $client->request('GET', 'https://wsmipres.sispro.gov.co/WSSUMMIPRESNOPBS/api/DireccionamientoXPrescripcion/802024817/_0hZFuEPhyPIbwAowjiePR8TMae8cIdhF4MCV5Dh7CA%3D/20201003197023452163', $headers);
