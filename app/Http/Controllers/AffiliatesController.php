...
class AffiliatesController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            ->select(DB::raw("a.id, a.document_number, a.delivery_contract_id, (a.firstname || ' ' || a.middlename || ' ' || a.lastname1 || ' ' || a.lastname2) as display_name, a.fistname, a.middlename, a.lastname1, a.lastname2, dc.name as contract, a.state"));
