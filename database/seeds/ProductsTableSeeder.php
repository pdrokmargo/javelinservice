    ...
    public function run()
    {
        DB::table('products')->insert([
            [
                ...
                'covered_period' => 20,
                'replacment_time' => 30,
                'pharmaceutical_drug' => '[{\"id\":\"222eb1a2-3704-4c27-b01d-7888e828b812\",\"name\":\"Acetaminof\\u00e9n\",\"routes_administration\":\"Oral\",\"dosage_form\":\"Tableta\",\"state\":true,\"is_pos\":true,\"concentration\":\"500 und\"}]',
                'state' => true,
            ],
        ]);
    }
